    ...
    return (
        <div className="list-component-container">
            <header className="list-header">
                ...
                {props.userName && (<div className="profile-information">
                    <p className="profile-user-name">Usuário: {props.userName} </p>
                    <p>Tipo: {props.userType}</p>
                    {props.userSuperType ? <p className="profile-user-type">Cargo: {props.userSuperType}</p> : <div></div>}
                </div>)}
